...
logger.add("/Users/candacechatman/dev/lchop/src/lchop/logfile.log")  # <-- Add this line to specify where logs should go

# ... (your existing imports and functions here)

if __name__ == '__main__':
    with DaemonContext(stdout=open("stdout.log", "w+"), stderr=open("stderr.log", "w+")):
